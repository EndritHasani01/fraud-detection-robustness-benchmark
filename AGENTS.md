...
- `docs/Paper_Summary.md`: task 1 write-up
- `docs/FINAL_PROJECT_GUIDE.md`: methodology and report outline
- `configs/`: frozen experiment definitions
- `_local_archive/todos/`: local historical implementation tasks (ignored)
